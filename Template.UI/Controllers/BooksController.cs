...
using Template.Application.Books.Commands.CreateBook;
using Template.Application.Books.Commands.DeleteBook;
using Template.Application.Books.Commands.UpdateBook;
using Template.Application.Books.Queries.GetAllBooks;
using Template.Application.Books.Queries.GetBookById;
...
namespace Template.UI.Controllers
{
    ...
    public class BooksController : ApiController
    {
        ...
        // DELETE: api/books/{id}
        [HttpDelete]
        public async Task<IActionResult> Remove(long id) // From route/query
        {
